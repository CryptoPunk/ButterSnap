...
export default defineConfig({
  shortcuts: [
    ...
    ['btn-icon', 'bg-white/5 w-12 h-12 flex items-center justify-center rounded-full border-1 border-white/10 text-white hover:(bg-white/15 scale-110 border-accent-secondary shadow-[0_0_15px_rgba(0,229,255,0.3)]) transition-all duration-200'],
    ['btn-icon-active', 'text-accent-secondary border-accent-secondary bg-accent-secondary/10 shadow-[0_0_10px_rgba(0,229,255,0.2)]'],
  ],
  theme: {
    colors: {
      accent: {
